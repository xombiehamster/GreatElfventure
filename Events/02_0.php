...
<p><?php echo firstcontact("Ehra");?>, with his permanent patient smile, sits at the table with <?php echo firstcontact("Siiri");?> beside him. There are a few papers stacked beside him. If there’s a crack in Ehra’s smile, you can’t tell. Like last year, <?php echo firstcontact("Katiin");?> waits for guests at the door. </p>
...
<p>As with the previous year, the winged elves are the first to arrive. <?php echo firstcontact("Shadimon");?> and <?php echo firstcontact("Anasatri");?> have come, along with a new face - <?php echo firstcontact("Dhakamari");?>, the head of the rangers. Dhakamari is shy, still uncertain about becoming an important community figure, and mostly lurks behind Shadimon. He’s carrying a large cloth bundle and trying (and failing) to be subtle about looking around at the frescos. </p>
...
<p>The river elf barge that had arrived was, in fact, the Hylidae Family raft.  This is quickly evidenced by <?php firstcontact("Litoria");?> and a very young elf that the others may not recognize arriving with the hippopotamus in tow.  Litoria carries a large earthenware crock, very similar to the one they brought last year, and the young elf has a bundle wrapped in linen, which he complains at length about as they enter.</p>
<p>“Nah, I ain’t gon’ let you shirk, <?php echo firstcontact("Acris");?>,” Litoria scolds on their way in, “Sauver ain’t yer packmule, an Smilisca gave you a task ta do.”</p>
<p>Litoria puts the crock down with a heavy thud on the floor near the table to not scratch its surface, giving away its hefty weight.  Sauver nudges her side, now standing as high as her shoulder.  Acris Hylidae grumbles more as he puts his bundle on the table as well.</p>
