...
<body>
    ...
    <?php 
        ...
        if($_SESSION["RIVER"]>=11){
            ...
            if($_SESSION["RIVER"]=11){
                echo getarrows("03_2_River.php#back","../Year/03_2_River.php#back");
            }
        }else{
        ...
        if($_SESSION["RIVER"]>=12){
            ...
            if($_SESSION["RIVER"]=12){
                echo getarrows("03_3_River.php#back","../Year/03_3_River.php#back");
            }
        }
        if($_SESSION["RIVER"]>=13){
            ...
            if($_SESSION["RIVER"]=13){
                echo getarrows("03_4_River.php#back","../Year/03_4_River.php#back");
            }else{
